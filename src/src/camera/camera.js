...
export class Camera {
  ...
  get viewProjectionMatrix() {
    ...
    this._cameraMatrix = Matrix4.translate(this._cameraMatrix.data, 0, 0, this.radius * 1.5);
    var cameraPosition = [
    ...
    this._viewProjectionMatrix = Matrix4.multiply(this._projectionMatrix.data, this._viewProjectionMatrix.data);
